...
//  Conversores
//
//  Created by diego passos on 20/12/21.
//
...
class ViewController: UIViewController {
    ...
    func calcCurrency(){
        ...
        if btUnit1.alpha == 1.0 {
            ...
            lbResult.text = String(currency / 5.69) //5.69 Cotacão do dolar 29/12/2021
        } else{
            lbResultUnit.text = "Real"
            lbResult.text = String(currency * 5.69 )
        }
